...
function playerstats(playerid, gid) {
    ...
    playerstats(playerids, gid)
    res.status(200).json({
        "status": 200,
        "message": 'fetched player and game stats for game:' + gid +' and player: ' + playerids
    })
    // endpoint example: http://localhost/nba/stats/202323/0021700608
}
